...
QNChatMessage::QNChatMessage(QWidget *parent) : QWidget(parent)
{
    ...
    m_loadingMovie->setFileName("loading4.gif");
...
void QNChatMessage::setRightPixmap(const QPixmap &newRightPixmap)
{
    m_rightPixmap = newRightPixmap;
}

void QNChatMessage::setLeftPixmap(const QPixmap &newLeftPixmap)
{
